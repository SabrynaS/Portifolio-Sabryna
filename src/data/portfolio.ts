...
export const experiences: Experience[] = [
  {
    ...
    description: [
      "Análise e desenvolvimento de sistemas do núcleo",
      "Aplicação de testes exploratórios nos sistemas desenvolvidos",
      "Atuação em projetos para clientes externos (ex.: TCE)",
      "Colaboração com equipe e registro de issues/achados",
    ],
    tags: ["Análise", "Desenvolvimento Web", "Testes Exploratórios", "Git"],
    current: true,
  },
  {
    id: "petcomp",
...
export const projects: Project[] = [
  ...
  },
  {
    ...
    shortDescription: "Teste exploratório em protótipo de alta fidelidade no Figma.",
    fullDescription: "Execução de testes exploratórios em protótipo de alta fidelidade desenvolvido no Figma, com reporte estruturado de achados. O trabalho resultou em um artigo científico aprovado como Experience Report.",
    role: "Execução de Testes Exploratórios + Reporte de Achados",
    deliverables: [
      "Execução de testes exploratórios",
      "Reporte estruturado de achados",
