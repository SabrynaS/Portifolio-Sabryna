...
export const experiences: Experience[] = [
  {
    ...
    role: "Analista, Desenvolvedora de Software e QA",
    ...
    description: [
      ...
      "Atuação em projetos para clientes externos (TCE, Equantorial)",
    ],
  ...
  },
  {
    ...
    description: [
      "Planejamento e execução de testes exploratórios no sistema, utilizando protótipo de alta fidelidade no Figma",
      "Identificação e documentação de problemas de fluxo, usabilidade e inconsistências de interface",
      "Registro de defeitos para priorização e ajustes",
...
export const projects: Project[] = [
  ...
  },
  {
    ...
    deliverables: [
      ...
      "Planejamento e execução de testes automatizados",
    ],
  ...
  },
  {
    ...
    role: "Execução de Testes Exploratórios + Reporte de Defeitos",
    deliverables: [
